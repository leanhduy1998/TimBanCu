...
class UpdateImageYearAlerts{
    ...
    private func setupYearOutOfLowerBoundAlert(){
        ...
        yearOutOfLowerBoundAlert = InfoAlert(title: title, message: message, alertType: .YearOutOfLowerBound)
    }
    ...
    private func setupYearIsInTheFutureAlert(){
        ...
        yearIsInTheFutureAlert = InfoAlert(title: title, message: message, alertType: .YearIsInTheFuture)
    }
}
