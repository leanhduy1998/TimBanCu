...
class AnimateAppNameView: UIView {
    ...
    func animate() {
        DispatchQueue.main.async {
            self.animateShimmeringText()
        }
    }
    
    func remove() {
        shimmerAppNameLabel.removeFromSuperview()
...
//        label.text = text
//        label.font = UIFont(name: Constants.App.font, size: Constants.App.fontSize)
